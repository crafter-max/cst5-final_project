...
// All CRUD operations originate from here via href/links.
...
// Load products, categories, and active filters via the read controller.
require_once 'read.php';

// Flash messages forwarded from cre_upd_prd.php and del_prd.php.
$flash_success = '';
$flash_error   = '';
...
<div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
    <div>
        <h4 class="mb-0 fw-bold" style="color: #12172a;">
                ...
                <table class="table table-hover mb-0 align-middle">
                    ...
                    <?php foreach ($products as $p): ?>
                        <tr>
                            ...
                            <td><span class="badge bg-light text-secondary border"><?= htmlspecialchars($p['category']) ?></span></td>
                            <td class="text-center">
                                <?php
                                    $qty_class = '';
                                    if ($p['status'] === 'low_stock') $qty_class = 'text-warning fw-bold';
                                    if ($p['quantity'] == 0)          $qty_class = 'text-danger fw-bold';
                                ?>
                                <span class="<?= $qty_class ?>">
                                    <?= number_format((int)$p['quantity']) ?>
                                </span>
                            </td>
                            ...
                            <td class="small text-muted"><?= htmlspecialchars($p['supplier'] ?: '—') ?></td>
                            <td class="text-center">
