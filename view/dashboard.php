<?php
// Main dashboard — displays the product inventory list with filters and CRUD actions.
...
<div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
    <div>
        <h4 class="mb-0 page-title"><i class="bi bi-boxes me-2"></i>Product Inventory</h4>
        <p class="page-subtitle mb-0 mt-1">
            Workspace: <strong><?= htmlspecialchars($_SESSION['workspace_id']) ?></strong>
        </p>
    </div>
    <a href="/view/add_upd.php" class="btn btn-brand">
...
<div class="filter-bar mb-4">
    <form method="GET" action="/view/dashboard.php" class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-3 d-flex gap-2">
            ...
            <a href="/view/dashboard.php" class="btn btn-outline-secondary btn-sm px-3">
...
<div class="card">
    <div class="card-header-custom d-flex align-items-center justify-content-between">
        <span class="fw-semibold"><i class="bi bi-table me-1"></i>Products</span>
        ...
        <?php if (empty($products)): ?>
            <div class="text-center py-5 empty-state">
                ...
                <?php if (array_filter($filters)): ?>
                    <br><a href="/view/dashboard.php" class="small">Clear filters</a>
                <?php else: ?>
                    <br>
                    <a href="/view/add_upd.php" class="btn btn-brand btn-sm mt-2">
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0 align-middle">
                    ...
                    <?php foreach ($products as $p): ?>
                        ...
                        ?>
                        <tr>
                            <td class="small" style="color:var(--text-muted);"><?= htmlspecialchars($p['sku']) ?></td>
                            <td class="fw-semibold">
                                <a href="/view/prd_view.php?id=<?= (int)$p['product_id'] ?>">
                                    <?= htmlspecialchars($p['product_name']) ?>
                                </a>
                            </td>
                            <td><span class="badge bg-light"><?= htmlspecialchars($p['category']) ?></span></td>
                            <td class="text-center">
                                <span class="<?= $qty_class ?>"><?= number_format($qty) ?></span>
                            </td>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-1">
                                    ...
                                    <a href="/view/add_upd.php?id=<?= (int)$p['product_id'] ?>"
